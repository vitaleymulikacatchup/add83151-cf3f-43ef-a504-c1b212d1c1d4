...
export const metadata: Metadata = {
  title: "VioBIBKA | Premium Car Rental Services",  description: "Rent premium vehicles at competitive prices. Book luxury cars, SUVs, and sports cars online. Fast booking, 24/7 support, and unlimited mileage included.",  keywords: ["car rental", "vehicle rental", "luxury cars", "SUV rental", "premium vehicles", "car hire"],
  openGraph: {
    title: "VioBIBKA | Premium Car Rental",    description: "Experience effortless car rental with VioBIBKA. Premium vehicles at competitive prices with 24/7 support.",    url: "https://vibibka.com",    siteName: "VioBIBKA",    images: [
      {
        url: "https://img.b2bpic.net/free-photo/it-has-few-special-functions-female-customer-modern-stylish-bearded-businessman-automobile-saloon_146671-16061.jpg",        alt: "VioBIBKA Premium Car Rental"
      }
    ],
    type: "website"
  },
  twitter: {
    card: "summary_large_image",    title: "VioBIBKA | Premium Car Rental",    description: "Book premium vehicles online with VioBIBKA. Luxury cars, SUVs, and sports cars available.",    images: ["https://img.b2bpic.net/free-photo/it-has-few-special-functions-female-customer-modern-stylish-bearded-businessman-automobile-saloon_146671-16061.jpg"]
  }
};
